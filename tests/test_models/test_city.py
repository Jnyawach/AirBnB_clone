...
class TestCity_instantiation(unittest.TestCase):
    """Testing for the instantiation of the City class."""
...
class TestCity_save(unittest.TestCase):
    """Testing for the save method of the City class."""
...
class TestCity_to_dict(unittest.TestCase):
    """Testing for the to_dict method of the City class."""
    ...
    def test_to_dict_contains_added_attributes(self):
        cy = City()
        cy.middle_name = "ALX School"
        cy.my_number = 98
        self.assertEqual("ALX School", cy.middle_name)
